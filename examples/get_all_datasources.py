...
def get_api_function_name(datasource_type):
    datasource = {data_source_type.DataSourceType.CISCOSWITCHDATASOURCE: {"list" : "list_cisco_switches", "get": "get_cisco_switch"},
                  data_source_type.DataSourceType.DELLSWITCHDATASOURCE: {"list": "list_dell_switches", "get": "get_dell_switch"},
                  data_source_type.DataSourceType.ARISTASWITCHDATASOURCE: {"list": "list_arista_switches", "get": "get_arista_switch"},
                  data_source_type.DataSourceType.BROCADESWITCHDATASOURCE: {"list": "list_brocade_switches", "get": "get_brocade_switch"},
                  data_source_type.DataSourceType.JUNIPERSWITCHDATASOURCE: {"list": "list_juniper_switches", "get": "get_juniper_switch"},
                  data_source_type.DataSourceType.VCENTERDATASOURCE: {"list": "list_vcenters", "get": "get_vcenter"},
                  data_source_type.DataSourceType.NSXVMANAGERDATASOURCE: {"list": "list_nsxv_managers", "get": "get_nsxv_manager"},
                  data_source_type.DataSourceType.UCSMANAGERDATASOURCE: {"list": "list_ucs_managers", "get": "get_ucs_manager"},
                  data_source_type.DataSourceType.HPVCMANAGERDATASOURCE: {"list": "list_hpvc_managers", "get": "get_hpvc_manager"},
                  data_source_type.DataSourceType.HPONEVIEWDATASOURCE: {"list": "list_hpov_managers", "get": "get_hpov_manager"},
                  data_source_type.DataSourceType.PANFIREWALLDATASOURCE: {"list": "list_panorama_firewalls", "get": "get_panorama_firewall"},
                  data_source_type.DataSourceType.CHECKPOINTFIREWALLDATASOURCE: {"list": "list_checkpoint_firewalls", "get": "get_checkpoint_firewall"},
                  data_source_type.DataSourceType.NSXTMANAGERDATASOURCE: {"list": "list_nsxt_managers", "get": "get_nsxt_manager"},
                  data_source_type.DataSourceType.INFOBLOXMANAGERDATASOURCE: {"list": "list_infoblox_managers", "get": "get_infoblox_manager"},
                  data_source_type.DataSourceType.POLICYMANAGERDATASOURCE: {"list": "list_policy_managers", "get": "get_policy_manager"},
                  data_source_type.DataSourceType.KUBERNETESDATASOURCE: {"list": "list_kubernetes_clusters", "get": "get_kubernetes_cluster"}}
